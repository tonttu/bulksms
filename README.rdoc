...
Sending a quick message is very simple:
  ...
  Bulksms.send(:message => 'Hello, I hope you like my message!', :recipient => '44799123456')

== Multiple messages

Provide an array of hashes and multiple messages will be sent via the same HTTP connection:

  Bulksms.send([{:message => 'Test Message', :recipient => "44342134131"}, {:message => "Another Msg", :recipient => "4441234354254"}])
